...
{    
    ...
    $getId=mysqli_fetch_row(mysqli_query($con,"select max(id) from berita_kegiatan, privasi"));
    ...
    mysqli_query($con,"insert into berita_kegiatan values('', '".date('Y-m-d')."','".($getId[0]+1).$ext."','$judul','$konten','$id_privasi', '$visitor', '$downloaded')");
...
elseif(isset($_POST['update']))
{
    ...
    { 
        ...
        mysqli_query($con,"update berita_kegiatan set gambar='".$_GET['id'].$ext."', judul='$judul', konten='$konten', id_privasi'$id_privasi', '$visitor', '$downloaded', where id='".$_GET['id']."'");
    }
    else
        mysqli_query($con,"update berita_kegiatan set judul='$judul', konten='$konten', where id='".$_GET['id']."'");
...
if(isset($_GET['id']))
$data=mysqli_fetch_row(mysqli_query($con,"select * from berita_kegiatan, privasi where id='".$_GET['id']."'"));
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Input Berita Kegiatan</h3>
                </div>
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" name="gambar" value="<?php echo isset($data[2])?$data[2]:''; ?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Judul Berita Kegiatan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Judul" name="judul" id="tiga" value="<?php echo isset($data[3])?$data[3]:''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Isi Berita Kegiatan</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_privasi" name="select">
                                ...
                                <?php echo isset($_GET['select'])?$data[5]:''; ?>
                              </select>
                            </div>
                        </div>
                    </div>
